...
const analyzeCompositionTest = async (inputData, sampleSize, maxNumberOfMatches) => {
    try {
        ...
        for (const matchId of matchesId) {
            ...
            for (const composition of participants) {
                ...
                if (isAMatch) {
                    ...
                    collectDataAboutItems(composition, inputData, itemsData, compositionUnits); // added composition units to method
                }
